					...
					<div class="col">
						<div class="settings-list row form-table">
							...
							<div class="tab-section-wrapper col-12 my-3 p-3 bg-white shadow-lg">
								<h4><?php esc_html_e( 'Optimization', 'wp-gif-editor' ); ?></h4>
									...
									<div class="settings-group my-4 py-4 col-md-12  ">
										<div class="row">
											...
											<div class="col-md-3 d-flex align-items-center mb-4 mb-md-0">
												<h6 class=""><?php esc_html_e( 'First Frame image', 'wp-gif-editor' ); ?></h6>
											</div>
											<!-- Field input -->
											<div class="col-md-9 d-flex align-items-center">
												<div class="input w-100">
													...
													<!-- Input Suffix -->
													<?php esc_html_e( 'Use GIF\'s first frame image at page load, then load the GIF after the page is loaded.', 'wp-gif-editor' ); ?>
													<!-- Input Footer -->
												</div>
											</div>
										</div>
